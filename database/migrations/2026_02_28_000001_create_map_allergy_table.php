...
return new class extends Migration {
    ...
    {
        Schema::create('map_allergy', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->unsignedInteger('allergy_id')->unique()->comment('ID dari tabel alergi SIMRS');
    ...
    {
        Schema::dropIfExists('map_allergy');
    }
};
