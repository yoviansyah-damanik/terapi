...
use App\Http\Controllers\Api\V1\ApiSimrsSlideController;
use App\Http\Controllers\Api\V1\ApiSimrsVersionController;
use App\Http\Controllers\Api\V1\DicomWorklistController;
use App\Http\Controllers\Api\V1\QrCodeController;
use App\Http\Controllers\Api\V1\SimrsLogController;
use App\Http\Controllers\Api\V1\TteController;
...
Route::prefix('v1')
    ...
    ->group(function () {
        ...
        // ── Autentikasi ───────────────────────────────────────────────────────
        Route::prefix('auth')
            ->middleware(['api.version:auth,v1'])
            ->group(function () {
        ...
        Route::middleware(['api.token', 'api.scope:hospital', 'throttle:api.general', 'api.version:hospital,v1'])
        ...
        // ── SIMRS ─────────────────────────────────────────────────────────────
        Route::middleware(['api.token', 'api.scope:simrs', 'throttle:api.general', 'api.version:simrs,v1'])
        ...
        // ── WhatsApp ──────────────────────────────────────────────────────────
        Route::middleware(['api.token', 'api.scope:whatsapp-gateway', 'throttle:api.general', 'api.size:5120', 'api.version:whatsapp,v1'])
        ...
        // ── TTE ───────────────────────────────────────────────────────────────
        Route::middleware(['api.token', 'api.scope:tte', 'throttle:api.general', 'api.size:20480', 'api.version:tte,v1'])
        ...
        // ── QR Code ───────────────────────────────────────────────────────────
        Route::middleware(['api.token', 'api.scope:qrcode', 'throttle:api.general', 'api.size:5120', 'api.version:qrcode,v1'])
            ->prefix('qrcode')->group(function () {
            Route::post('/generate', [QrCodeController::class, 'generate']);
        });

        // ── AI Provider ───────────────────────────────────────────────────────
        Route::middleware(['api.token', 'api.scope:ai', 'throttle:api.general', 'api.size:2048', 'api.version:ai,v1'])
            ->prefix('ai')->group(function () {
            Route::post('/prompt', [ApiAiController::class, 'prompt']);
        });

        // ── DICOM Worklist ────────────────────────────────────────────────────
        Route::middleware(['api.token', 'api.scope:dicom', 'throttle:api.general', 'api.version:dicom,v1'])
        ...
        Route::middleware(['api.token', 'throttle:api.general'])->prefix('status')->group(function () {
