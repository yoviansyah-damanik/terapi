...
new #[Layout('layouts::app')] #[Title('RL 3.10 - Rujukan')] class extends Component {
    #[Url]
    public int $tahun = 0;
    #[Url]
    public int $bulan = 0;
    ...
    public function with(): array
    {
        ...
        return [
            'data' => $service->getRL310($this->tahun, $this->bulan),
...
<div>
    <x-sirs.report-header title="RL 3.10 - Rujukan" subtitle="Data bulanan" :profil="$profil" :bulan="$namaBulan"
        :tahun="$tahun" />
            ...
            <tbody class="bg-white divide-y divide-zinc-200 dark:bg-primary-dark-800 dark:divide-primary-dark-700">
                ...
                <tr class="bg-primary-50 dark:bg-primary-900/20 font-bold">
                    ...
                    <td class="px-4 py-3 text-center text-zinc-900 dark:text-primary-dark-100">
                        {{ number_format($data['masuk'] + $data['keluar']) }}</td>
                </tr>
            </tbody>
        </table>
    </div>

    <x-sirs.export-buttons rl="3.10" />
</div>
