...
new #[Layout('layouts::app')] #[Title('RL 5.3 - 10 Besar Kunjungan Rajal')] class extends Component {
    #[Url]
    public int $tahun = 0;
    #[Url]
    public int $bulan = 0;
    ...
    public function with(): array
    {
        ...
        return [
            'data' => $service->getRL53($this->tahun, $this->bulan),
...
<div>
    <x-sirs.report-header title="RL 5.3 - 10 Besar Penyakit Rawat Jalan (Kunjungan)"
        subtitle="Berdasarkan diagnosa utama seluruh kunjungan" :profil="$profil" :bulan="$namaBulan" :tahun="$tahun" />
