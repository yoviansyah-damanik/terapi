...
new #[Layout('layouts::app')] #[Title('RL 3.11 - Gigi & Mulut')] class extends Component {
    #[Url]
    public int $tahun = 0;
    ...
    public function with(): array
    {
        ...
        return [
            'data' => $service->getRL311($this->tahun),
...
<div>
    <x-sirs.report-header title="RL 3.11 - Gigi dan Mulut" subtitle="Data tahunan" :profil="$profil" :tahun="$tahun" />
