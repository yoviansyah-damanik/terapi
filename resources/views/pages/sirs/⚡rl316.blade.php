...
new #[Layout('layouts::app')] #[Title('RL 3.16 - Keluarga Berencana')] class extends Component {
    #[Url]
    public int $tahun = 0;
    ...
    public function with(): array
    {
        ...
        return [
            'data' => $service->getRL316($this->tahun),
...
<div>
    <x-sirs.report-header title="RL 3.16 - Keluarga Berencana" subtitle="Data tahunan, berdasarkan diagnosa Z30"
        :profil="$profil" :tahun="$tahun" />
