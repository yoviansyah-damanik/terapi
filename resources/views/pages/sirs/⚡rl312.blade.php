...
new #[Layout('layouts::app')] #[Title('RL 3.12 - Pembedahan')] class extends Component {
    #[Url]
    public int $tahun = 0;
    #[Url]
    public int $bulan = 0;
    ...
    public function with(): array
    {
        ...
        return [
            'data' => $service->getRL312($this->tahun, $this->bulan),
...
<div>
    <x-sirs.report-header title="RL 3.12 - Pembedahan" subtitle="Data bulanan per kategori operasi" :profil="$profil"
