...
new #[Layout('layouts::app')] #[Title('RL 3.15 - Kesehatan Jiwa')] class extends Component {
    #[Url]
    public int $tahun = 0;
    ...
    public function with(): array
    {
        ...
        return [
            'data' => $service->getRL315($this->tahun),
...
<div>
    <x-sirs.report-header title="RL 3.15 - Kesehatan Jiwa" subtitle="Data tahunan" :profil="$profil" :tahun="$tahun" />
