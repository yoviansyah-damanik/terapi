...
new #[Layout('layouts::app')] #[Title('RL 3.9 - Radiologi')] class extends Component {
    #[Url]
    public int $tahun = 0;
    #[Url]
    public int $bulan = 0;
    ...
    public function with(): array
    {
        ...
        return [
            'data' => $service->getRL39($this->tahun, $this->bulan),
...
<div>
    <x-sirs.report-header title="RL 3.9 - Pelayanan Radiologi" subtitle="Data bulanan" :profil="$profil" :bulan="$namaBulan"
        :tahun="$tahun" />
