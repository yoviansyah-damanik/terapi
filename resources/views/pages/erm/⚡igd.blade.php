...
new #[Layout('layouts::app')] #[Title('eRM — IGD')] #[Lazy] class extends Component {
    ...
    {
        // Identifikasi kode poliklinik IGD berdasarkan nama
...
<div>
    <x-ui.page-header title="eRM — IGD"
        subtitle="Status pengiriman rekam medis elektronik kunjungan IGD ke BPJS dan Satu Sehat" />
    ...
    {{-- Peringatan jika tidak ada poliklinik IGD terdeteksi --}}
    @if (empty($igdCodes))
        <div class="p-4 mb-4 text-sm rounded-lg bg-amber-50 dark:bg-amber-900/20 text-amber-800 dark:text-amber-300">
            Tidak ada poliklinik IGD terdeteksi. Pastikan nama poliklinik IGD mengandung kata "gawat" atau kode
            poliklinik mengandung "igd"/"ugd".
        </div>
    @endif
